...
dependencies {
    ...
    implementation ("com.squareup.okhttp3:logging-interceptor:4.9.3") // Versi terbaru
    ...
    implementation ("com.google.android.gms:play-services-location:21.0.1") // Pastikan versi terbaru
}